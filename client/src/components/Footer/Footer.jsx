        ...
        <div className="flex flex-col space-y-6 h-fit p-8 ssm:p-6 justify-center items-center text-slate_white w-full bg-bg_variant1 caret-transparent text-base ssm:text-sm subpixel-antialiased">
            <div className="flex flex-col space-y-12">
                <div className="h-fit w-80 p-2 sm:h-fit sm:w-64 flex flex-col items-center mx-auto justify-center ssm:items-start">
                    <h1 className="text-2xl ssm:text-2xl font-bold mb-1">Get to Know Us</h1>
                ...
                <div className="h-fit w-80 sm:h-fit ssm:w-64 flex flex-col items-center justify-center sm:items-start">
                    <h1 className="text-2xl ssm:text-2xl sm:w-64 font-bold mb-1 text-center">What's there to Explore</h1>
                    <ul className="list-inside md:px-1 underline w-56 ssm:w-48 text-center sm:text-start text-slate-white text-lg font-medium">
                ...
                <div className="h-28 w-80 sm:h-fit sm:w-64 flex flex-col items-center justify-center sm:items-start">
                    <h1 className="text-2xl sm:text-2xl font-bold mb-1">Doing Business</h1>
                ...
                <div className="flex flex-col space-y-1 items-center justify-center">
                    ...
                    <div className="flex flex-row text-sm space-x-3 justify">
                        ...
                        <div className="flex space-x-2 items-center">
                            <div className="size-4 outline"><img src='/assets/icon/copyright.svg' /> </div> 
                            <p>2024 NextMeal </p>
                        </div>
                    </div>
                </div>
