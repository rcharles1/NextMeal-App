...
function Stakeholdership() {
    return (
        <div className="partners h-fit w-full p-4 leading-relaxed pb-20 ssm:px-12">
            <h1 className="text-3xl ssm:text-4xl lg:text-5xl font-extrabold text-center">Partner with NextMeal </h1>
            <h3 className="text-sm text-center font-semibold text-default/50">Become a Partner, Sponsor or a Contributor </h3>
            <div className="mt-4 px-2 ssm:px-4 text-base">
                <p className="mt-2">Join us in our mission to ensure no one goes hungry. Whether you are a restaurant owner looking to partner with us, a volunteer eager to lend a helping hand, or a food enthusiast wanting to explore and share culinary delights, NextMeal offers various ways to get involved.</p>
                    <ul className="list-decimal ml-8 space-y-4">
                        <li className="mt-2 space-y-1 ssm:space-y-2">
                            ...
                            <p>Partners add their services - listings, reservation systems, delivery services, and exclusive deals, joining marketing efforts, and offering special deals. <Link to='/stakeholders/#content' className="font-medium underline underline-offset-2 text-sm">Partner NextMeal</Link></p>
                        </li>
                        <li className="mt-2 space-y-1 ssm:space-y-2">
