...
function Stakeholders() {
    return (
        <div className="min-h-screen w-full p-4 text-default/75 space-y-3 max-w-[80rem] mx-auto pb-10 ssm:flex ssm:space-x-6 ssm:space-y-0">
            <div className="hidden w-52 p-2 h-fit sticky top-8">
