                    ...
                    <form  onSubmit={handleSubmit}>
                        <label className="flex">
                            <div className="relative w-full">
                                ...
                                <input type="email" name="email" placeholder='Email Address' required className="p-2.5 px-12 ml-1 w-full md:p-2 md:pl-12 md:text-xs font-medium rounded-md caret-default bg-light_dark/10 focus:outline-none focus:ring-2 ring-bg_variant1 "/>
                            </div>
                        </label>
