...
export function Filter({ fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-2.5 lg:h-8" viewBox="0 0 24 24"><path fill='none' stroke={fill} strokeLinecap="round" strokeMiterlimit={10} strokeWidth={1.5} d="m19.795 4.413l-5.074 7.852a1.79 1.79 0 0 0-.287.987v4.788a1.229 1.229 0 0 1-.678 1.09l-3.662 1.826a.356.356 0 0 1-.528-.322v-7.382a1.803 1.803 0 0 0-.287-.987L4.205 4.413A.976.976 0 0 1 5.112 3h13.776a.975.975 0 0 1 .907 1.412Z"></path></svg>);
}

export function Sort({ fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-2.5 lg:h-8" viewBox="0 0 48 48" ><path fill='none' stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M19 6v36M7 17.9l12-12m10 36.2v-36m0 36l12-12"></path></svg>);
}
...
export function Bookmark({fill, stroke}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-4 lg:h-8"viewBox="0 0 24 24" ><path fill={fill} stroke={stroke} strokeLinecap="round" strokeLinejoin="round" d="M16 3H8a2 2 0 0 0-2 2v16l6-3l6 3V5a2 2 0 0 0-2-2"></path></svg>);
}
...
export function CheckIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-4 lg:h-8" viewBox="0 0 56 56"><path fill={fill} d="M23.664 52.399c2.953 2.976 5.695 2.953 8.649 0l3.609-3.587c.375-.351.703-.492 1.195-.492h5.063c4.195 0 6.14-1.922 6.14-6.14v-5.063c0-.492.141-.82.492-1.195l3.563-3.61c3-2.953 2.976-5.695 0-8.648l-3.563-3.61c-.351-.35-.492-.702-.492-1.171v-5.086c0-4.172-1.922-6.14-6.14-6.14h-5.063c-.492 0-.82-.118-1.195-.47l-3.61-3.585c-2.953-2.977-5.695-2.953-8.648 0l-3.61 3.586c-.35.351-.702.468-1.171.468h-5.086c-4.195 0-6.14 1.922-6.14 6.14v5.087c0 .469-.118.82-.47 1.172l-3.585 3.61c-2.977 2.952-2.953 5.694 0 8.648l3.586 3.609c.351.375.468.703.468 1.195v5.063c0 4.195 1.946 6.14 6.14 6.14h5.087c.469 0 .82.141 1.172.492Zm.375-12.61c-.726 0-1.195-.234-1.547-.633l-7.828-8.695a2.027 2.027 0 0 1-.515-1.336c0-1.102.843-1.922 2.039-1.922c.632 0 1.101.211 1.523.656l6.21 6.868l12.071-16.993c.469-.68.938-.96 1.758-.96c1.148 0 1.969.843 1.969 1.945c0 .398-.164.867-.422 1.242L25.633 39.063c-.352.445-.89.726-1.594.726"></path></svg>);
}
...
export function RatingBubble({fill, stroke}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-3 md:h-3 lg:h-4" viewBox="0 0 24 24"><circle cx={12} cy={12} r={9} fill={fill} stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}></circle></svg>);
}

export function CircleHalfFull({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24"><path fill={fill} d="M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2m0 2a8 8 0 0 1 8 8a8 8 0 0 1-8 8z"></path></svg>);
}
...
export function LocationIcon({stroke, fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-3 lg:h-8" viewBox="0 0 24 24" ><g fill={fill} stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}><path d="M12.56 20.82a.964.964 0 0 1-1.12 0C6.611 17.378 1.486 10.298 6.667 5.182A7.592 7.592 0 0 1 12 3c2 0 3.919.785 5.333 2.181c5.181 5.116.056 12.196-4.773 15.64"></path><path d="M12 12a2 2 0 1 0 0-4a2 2 0 0 0 0 4"></path></g></svg>);
}
...
export function CompanyIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  className="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><path fill={fill} d="M18 15h-2v2h2m0-6h-2v2h2m2 6h-8v-2h2v-2h-2v-2h2v-2h-2V9h8M10 7H8V5h2m0 6H8V9h2m0 6H8v-2h2m0 6H8v-2h2M6 7H4V5h2m0 6H4V9h2m0 6H4v-2h2m0 6H4v-2h2m6-10V3H2v18h20V7z"></path></svg>);
}

export function PricetagIcon({stroke, fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  className="h-5 md:h-4 lg:h-8" viewBox="0 0 512 512" ><path fill="none" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M403.29 32H280.36a14.46 14.46 0 0 0-10.2 4.2L24.4 281.9a28.85 28.85 0 0 0 0 40.7l117 117a28.86 28.86 0 0 0 40.71 0L427.8 194a14.46 14.46 0 0 0 4.2-10.2v-123A28.66 28.66 0 0 0 403.29 32"></path><path fill={fill} d="M352 144a32 32 0 1 1 32-32a32 32 0 0 1-32 32"></path><path fill="none" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="m230 480l262-262a13.8 13.8 0 0 0 4-10V80"></path></svg>);
}
...
export function PreviousIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-4 lg:h-8"viewBox="0 0 24 24" ><path fill={fill} d="M19 11H7.83l4.88-4.88c.39-.39.39-1.03 0-1.42a.996.996 0 0 0-1.41 0l-6.59 6.59a.996.996 0 0 0 0 1.41l6.59 6.59a.996.996 0 1 0 1.41-1.41L7.83 13H19c.55 0 1-.45 1-1s-.45-1-1-1"></path></svg>);
}

export function DirectionIcon({stroke}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" className="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><path fill="none" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="m9.706 12.781l-5.316-.953a2.085 2.085 0 0 1-.167-3.96l14.11-4.992a2.084 2.084 0 0 1 2.673 2.673l-4.992 14.386a2.084 2.084 0 0 1-3.91-.098l-.914-5.572a2.015 2.015 0 0 0-1.484-1.484m5.571-3.979l-4.579 4.579"></path></svg>);
}
...
export function MdiLocation(props) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}><path fill="#fafafa" d="M12 11.5A2.5 2.5 0 0 1 9.5 9A2.5 2.5 0 0 1 12 6.5A2.5 2.5 0 0 1 14.5 9a2.5 2.5 0 0 1-2.5 2.5M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7"></path></svg>);
}