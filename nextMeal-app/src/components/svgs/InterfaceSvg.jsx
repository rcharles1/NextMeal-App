...
export function CircleHalfFull({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24"><path fill={fill} d="M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2m0 2a8 8 0 0 1 8 8a8 8 0 0 1-8 8z"></path></svg>);
}

export function Share({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><path fill={fill} fillRule="evenodd" d="M16.5 2.25a3.25 3.25 0 0 0-3.2 3.824L8.57 9.386a.757.757 0 0 0-.068.053a3.25 3.25 0 1 0 0 5.121a.755.755 0 0 0 .068.054l4.73 3.312a3.25 3.25 0 1 0 .617-1.4l-4.479-3.135c.2-.422.312-.893.312-1.391s-.112-.97-.312-1.391l4.48-3.136A3.25 3.25 0 1 0 16.5 2.25M14.75 5.5a1.75 1.75 0 1 1 3.5 0a1.75 1.75 0 0 1-3.5 0M6.5 10.25a1.75 1.75 0 1 0 0 3.5a1.75 1.75 0 0 0 0-3.5m10 6.5a1.75 1.75 0 1 0 0 3.5a1.75 1.75 0 0 0 0-3.5" clipRule="evenodd"></path></svg>);
}

export function LocationIcon({stroke, fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><g fill={fill} stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}><path d="M12.56 20.82a.964.964 0 0 1-1.12 0C6.611 17.378 1.486 10.298 6.667 5.182A7.592 7.592 0 0 1 12 3c2 0 3.919.785 5.333 2.181c5.181 5.116.056 12.196-4.773 15.64"></path><path d="M12 12a2 2 0 1 0 0-4a2 2 0 0 0 0 4"></path></g></svg>);
}

export function BrandIcon({ fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><path fill={fill} d="M10 17h9v-6h-9zm-6 3q-.825 0-1.412-.587T2 18V6q0-.825.588-1.412T4 4h16q.825 0 1.413.588T22 6v12q0 .825-.587 1.413T20 20zm0-2h16V6H4zm0 0V6z"></path></svg>);
}

export function CompanyIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><path fill={fill} d="M18 15h-2v2h2m0-6h-2v2h2m2 6h-8v-2h2v-2h-2v-2h2v-2h-2V9h8M10 7H8V5h2m0 6H8V9h2m0 6H8v-2h2m0 6H8v-2h2M6 7H4V5h2m0 6H4V9h2m0 6H4v-2h2m0 6H4v-2h2m6-10V3H2v18h20V7z"></path></svg>);
}

export function PricetagIcon({stroke, fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 512 512" ><path fill="none" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M403.29 32H280.36a14.46 14.46 0 0 0-10.2 4.2L24.4 281.9a28.85 28.85 0 0 0 0 40.7l117 117a28.86 28.86 0 0 0 40.71 0L427.8 194a14.46 14.46 0 0 0 4.2-10.2v-123A28.66 28.66 0 0 0 403.29 32"></path><path fill={fill} d="M352 144a32 32 0 1 1 32-32a32 32 0 0 1-32 32"></path><path fill="none" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="m230 480l262-262a13.8 13.8 0 0 0 4-10V80"></path></svg>);
}

export function RibbonIcon({ fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" class="h-5 md:h-4 lg:h-8" viewBox="0 0 20 20" ><path fill={fill} d="M12.825 10.653c.118-.258.445-.497.727-.529s.539-.29.571-.572c.034-.28.272-.608.529-.727a.69.69 0 0 0 .369-.72c-.058-.278.068-.663.276-.854a.689.689 0 0 0 .127-.801a1.017 1.017 0 0 1 0-.897a.688.688 0 0 0-.127-.801c-.208-.193-.333-.577-.276-.854a.691.691 0 0 0-.369-.722a1.03 1.03 0 0 1-.529-.727a.689.689 0 0 0-.571-.572a1.024 1.024 0 0 1-.727-.528a.686.686 0 0 0-.722-.366a1.024 1.024 0 0 1-.854-.278c-.193-.21-.553-.266-.8-.127s-.652.139-.898 0a.684.684 0 0 0-.801.125a1.022 1.022 0 0 1-.854.278a.685.685 0 0 0-.72.367c-.119.256-.446.495-.728.527a.69.69 0 0 0-.572.573a1.023 1.023 0 0 1-.529.726a.69.69 0 0 0-.366.722c.055.277-.07.662-.278.854s-.266.552-.127.801c.139.246.139.651 0 .897a.69.69 0 0 0 .127.802c.209.19.333.575.278.854a.687.687 0 0 0 .366.72c.258.119.495.447.528.727c.034.282.29.54.572.572s.609.272.728.529a.688.688 0 0 0 .72.366c.278-.055.663.069.854.278a.69.69 0 0 0 .801.127c.246-.139.651-.139.898 0s.607.081.8-.127c.193-.21.576-.333.854-.278a.69.69 0 0 0 .723-.365M10 9.399a3.4 3.4 0 1 1 0-6.8a3.4 3.4 0 0 1 0 6.8m-4.025 2.01l-1.243 7.049l3.128-.464l2.781 1.506l1.238-7.021a6.707 6.707 0 0 1-5.904-1.07m7.986.048a6.741 6.741 0 0 1-.99.597l-.748 4.236l3.369-1.828z"></path></svg>);
}

export function VolumeIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 36 36" ><path fill={fill} d="M25.88 32H12a4 4 0 0 1-4-4V11.46L2.31 5.77a1 1 0 0 1-.22-1.09A1 1 0 0 1 3 4.06h25.86a1 1 0 0 1 1 1V28a4 4 0 0 1-3.98 4M5.43 6l4.28 4.34a.75.75 0 0 1 .21.63v17A2.13 2.13 0 0 0 12 30h13.88A2.1 2.1 0 0 0 28 28V6Z" className="clr-i-outline clr-i-outline-path-1"></path><path fill={fill} d="M33 16a1 1 0 0 1-1-1V6h-3.14a.92.92 0 0 1-1-.9a1 1 0 0 1 1-1H33a1 1 0 0 1 1 1V15a1 1 0 0 1-1 1" className="clr-i-outline clr-i-outline-path-2"></path><path fill={fill} d="M24 11h-6a1 1 0 1 1 0-2h6a1 1 0 1 1 0 2" className="clr-i-outline clr-i-outline-path-3"></path><path fill={fill} d="M24 15h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2" className="clr-i-outline clr-i-outline-path-4"></path><path fill={fill} d="M24 19h-6a1 1 0 1 1 0-2h6a1 1 0 1 1 0 2" className="clr-i-outline clr-i-outline-path-5"></path><path fill={fill} d="M24 27h-6a1 1 0 1 1 0-2h6a1 1 0 1 1 0 2" className="clr-i-outline clr-i-outline-path-6"></path><path fill={fill} d="M24 23h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2" className="clr-i-outline clr-i-outline-path-7"></path><path fill="none" d="M0 0h36v36H0z"></path></svg>);
}

export function MapPinIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" class="h-5 md:h-4 lg:h-8" viewBox="0 0 320 512" ><path fill={fill} d="M16 144a144 144 0 1 1 288 0a144 144 0 1 1-288 0m144-64c8.8 0 16-7.2 16-16s-7.2-16-16-16c-53 0-96 43-96 96c0 8.8 7.2 16 16 16s16-7.2 16-16c0-35.3 28.7-64 64-64m-32 400V317.1a177.984 177.984 0 0 0 64 0V480c0 17.7-14.3 32-32 32s-32-14.3-32-32"></path></svg>);
}

export function CartRemoveIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><g fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} color={fill}><path d="m8 16l8.72-.727c2.729-.227 3.341-.823 3.643-3.544L21 6M6 6h2m14 0h-3.5m-8-3l3 3m0 0l3 3m-3-3l-3 3m3-3l3-3"></path><circle cx={6} cy={20} r={2}></circle><circle cx={17} cy={20} r={2}></circle><path d="M8 20h7M2 2h.966c.945 0 1.768.625 1.997 1.515L7.94 15.076a1.96 1.96 0 0 1-.35 1.686L6.631 18"></path></g></svg>);
}

export function CartAddIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24"><g fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} color={fill}><path d="m8 16l8.72-.727c2.729-.227 3.341-.823 3.643-3.544L21 6M6 6h.5M22 6h-2.5m-10 0h7M13 9.5v-7"></path><circle cx={6} cy={20} r={2}></circle><circle cx={17} cy={20} r={2}></circle><path d="M8 20h7M2 2h.966c.945 0 1.768.625 1.997 1.515L7.94 15.076a1.96 1.96 0 0 1-.35 1.686L6.631 18"></path></g></svg>);
}

export function CartIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"  class="h-5 md:h-4 lg:h-8" viewBox="0 0 24 24" ><g fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} color={fill}><path d="m8 16l8.72-.727c2.729-.227 3.341-.823 3.643-3.544L21 6M6 6h16"></path><circle cx={6} cy={20} r={2}></circle><circle cx={17} cy={20} r={2}></circle><path d="M8 20h7M2 2h.966c.945 0 1.768.625 1.997 1.515L7.94 15.076a1.96 1.96 0 0 1-.35 1.686L6.631 18"></path></g></svg>);
}

export function ArrowDownIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" class="h-5 md:h-4 lg:h-8" viewBox="0 0 1024 1024"><path fill={fill} d="M831.872 340.864L512 652.672L192.128 340.864a30.59 30.59 0 0 0-42.752 0a29.12 29.12 0 0 0 0 41.6L489.664 714.24a32 32 0 0 0 44.672 0l340.288-331.712a29.12 29.12 0 0 0 0-41.728a30.59 30.59 0 0 0-42.752 0z"></path></svg>);
}

export function ArrowUpIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg"class="h-5 md:h-4 lg:h-8" viewBox="0 0 1024 1024"><path fill={fill} d="m488.832 344.32l-339.84 356.672a32 32 0 0 0 0 44.16l.384.384a29.44 29.44 0 0 0 42.688 0l320-335.872l319.872 335.872a29.44 29.44 0 0 0 42.688 0l.384-.384a32 32 0 0 0 0-44.16L535.168 344.32a32 32 0 0 0-46.336 0"></path></svg>);
}

export function PreviousIcon({fill}) {
	return (<svg xmlns="http://www.w3.org/2000/svg" class="h-5 md:h-4 lg:h-8"viewBox="0 0 24 24" ><path fill={fill} d="M19 11H7.83l4.88-4.88c.39-.39.39-1.03 0-1.42a.996.996 0 0 0-1.41 0l-6.59 6.59a.996.996 0 0 0 0 1.41l6.59 6.59a.996.996 0 1 0 1.41-1.41L7.83 13H19c.55 0 1-.45 1-1s-.45-1-1-1"></path></svg>);
}
