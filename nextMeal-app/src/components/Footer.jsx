...
function Footer() {
    return (
        <div className="antialiased flex flex-col space-y-6 h-fit p-8 sm:p-6 justify-center items-center text-pure_white w-100 bg-bg_variant1 caret-transparent text-base sm:text-sm">
