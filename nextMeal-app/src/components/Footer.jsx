        ...
        <div className="flex flex-col space-y-6 h-fit p-8 justify-center items-center text-pure_white w-100 bg-bg_variant1 caret-transparent text-sm">
            <div className="flex sm:flow-row sm:justify-around w-full text-start">
                ...
                <div className="h-28 w-64 flex flex-col items-center justify-center">
                    <h1 className="text-lg sm:text-xl font-bold mb-1">Get to Know Us</h1>
                ...
                <div className="h-28 w-64 flex flex-col items-center justify-center">
                    <h1 className="text-lg sm:text-xl font-bold mb-1">Doing Business</h1>
                    <ul className="list-inside px-5 text-slate-white text-center sm:text-start font-medium text-sm">
