...
function Footer() {
    return (
        <div className="antialiased flex flex-col space-y-6 h-fit p-8 sm:p-6 justify-center items-center text-pure_white w-100 bg-bg_variant1 caret-transparent text-base sm:text-xs">
            <div className="flex flex-col sm:flex-row sm:items-top sm:space-y-0 space-y-12 justify-center px-10 sm:px-0 sm:flow-row sm:space-x-4 sm:items-top w-full text-start">
                <div className="h-36 sm:h-fit sm:w-64 w-64 flex flex-col items-center justify-center sm:items-start">
                    <h1 className="text-xl sm:text-2xl md:text-base sm:w-64 font-bold mb-1">What's there to Explore</h1>
                ...
                <div className="h-28 w-64 sm:h-fit sm:w-64 flex flex-col items-center justify-center sm:items-start">
                    <h1 className="text-xl sm:text-2xl md:text-base font-bold mb-1">Get to Know Us</h1>
                ...
                <div className="h-28 w-64 sm:h-fit sm:w-64 flex flex-col items-center justify-center sm:items-start">
                    <h1 className="text-xl sm:text-2xl md:text-base font-bold mb-1">Doing Business</h1>
            ...
            <div className="h-32 w-64 p-2 flex flex-col space-y-4 items-center justify-center md:space-y-0">
                ...
                <div className="flex flex-col space-y-1 items-center justify-center">
                    ...
                    <div className="flex flex-row text-xs space-x-3 justify">
