...
function LocationAddress() {
  ...
  return (
    <div className="flex flex-row justify-center items-center space-x-3 md:space-x-2 md:px-4 h-12 w-fit bg-blur sm:h-16 sm:w-48 md:h-10 md:w-fit p-3 border border-slate_white/30 rounded-md drop-shadow">
