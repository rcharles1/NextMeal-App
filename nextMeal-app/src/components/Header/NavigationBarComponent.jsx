                                                ...
                                                {item.dropDownContent.map((content, index) => {
                                                    return (
                                                        <div key={index} className="flex flex-col max-w-80 lg:w-full">
                                                            <NavLink to={`${content.link}`} className="text-sm w-full p-1 font-semibold text-default/90 hover:underline hover:underline-offset-2 lg:text-lg">{content.title }</NavLink>
                                                            <p className="text-xs text-default/65 mt-1 lg:text-sm">{content.summary}</p>
                                                        </div>
                                                    )
                                                })}
                                            </div>
                                ...
                                {navItems.map((item) => (
                                    <li
                                        ...
                                        className={classNames(
                                            "cursor-pointer p-1 text-6xl font-black subpixel-antialiased text-slate_white/45",
                                            {
                                                "text-pure_white ":
