        ...
        <div className="flex flex-col w-full h-2/3 ssm:px-8 space-y-8 justify-center items-center ssm:space-y-6 caret-transparent antialised">
           <div className="flex flex-col w-full ssm:flex-row ssm:justify-between ssm:items-center ssm:space-x-4">
                ...
                <div className="font-semibold flex flex-col text-center ssm:text-start px-4 ssm:p-4 ssm:w-11/12"> 
                    ...
                    <p className="mt-3 ssm:mt-4 leading-relaxed text-start ssm:text-base lg:text-lg indent-2 p-1 text-default/75">
            ...
            <div className="flex flex-col space-y-4 px-5 ssm:grid ssm:grid-cols-3 gap-6 ssm:p-2 ssm:py-1 ssm:space-y-0 lg:grid-cols-4">
                {services.map((service, index) => {
                    return (
                        <div className="flex-col space-y-2 overflow-hidden w-full p-2 mx-auto justify-start items-center rounded-lg ssm:rounded-xl bg-pure_white drop-shadow-sm ssm:space-x-0 ssm:space-y-2 ssm:h-72 ssm:w-64 hover:bg-gradient-to-b from-pure_white to-bg_variant1/15 transition transform hover:-translate-y-1 ease-in-out delay-100">
