...
function Services() {
    return (
        <div className="flex flex-col w-100 h-2/3 space-y-8 justify-center items-center sm:space-y-1 caret-transparent antialised">
            ...
            <div className="flex flex-col space-y-8 px-5 md:flex-row md:space-x-6 sm:py-1">
                <div className="space-y-8 sm:space-y-6 mt-2 sm:mt-8">
                    ...
                    <div className="flex flex-row space-x-3 h-48 sm:h-56 w-80 p-3 justify-start items-center rounded-lg bg-pure_white drop-shadow-sm sm:w-96 sm:h-48 sm:space-x-4">
                ...
                <div className="flex flex-col space-y-3 h-96 py-4 w-80 p-3 sm:w-96 justify-start items-center rounded-lg bg-pure_white drop-shadow-sm sm:h-full">
