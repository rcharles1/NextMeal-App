        ...
        <>
            {!restaurants ? <p>Loading...</p> : 
                restaurants.map((restaurant) => {
                    <div className="flex flex-col outline space-y-4 h-72 w-40 rounded-xl sm:rounded-2xl px-2.5 py-2.5 text-sm bg-pure_white drop-shadow text-center sm:h-72 sm:w-56">
                        <div className="relative h-32 sm:h-36 w-full mx-auto rounded-lg sm:rounded-xl overflow-hidden">
                            <div className="absolute inset-0"><img src={restaurant.gallery.img1} alt='restaurant photo' /></div>
                        ...
                        <div className="w-fit ml-12 border-b-2 active:border-bg_variant1 justify-center flex flex-row space-x-1">
                            <span><NavLink to='/restaurantprofile' className="font-semibold text-xs sm:text-base active:text-bg_variant1">Learn More</NavLink></span>
