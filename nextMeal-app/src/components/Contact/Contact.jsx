...
function Contacts() {
    ...
    return (
        <div className="p-8 px-5 ssm:px-10 h-fit ssm:text-start ssm:flex ssm:space-x-8 text-winterWhite/75">
            <div className="hidden ssm:block h-fit p-2 w-3/12 pt-10 sticky top-16">
                ...
                <ul className="flex flex-col space-y-2 mt-1.5 pl-1 text-sm">
            ...
            <div id="page-content" className="space-y-8 ssm:text-base">
                ...
                <div id="helpingyou">
                    <h3 className="font-bold text-bg_variant1 ssm:text-lg">Let’s Help You!</h3>
                ...
                <div id="whyreachout">
                    <h3 className="font-bold text-bg_variant1 ssm:text-lg">Why Reach Out?</h3>
                    <ul className="mt-2 ml-8 mb-4 list-disc space-y-3">
                        <li className="space-x-1 mb-1"><span className="font-bold text-bg_variant1">Assistance in Finding the Perfect Spot</span> <p className="hover:">Leverage my extensive experience in software development and IT to solve your toughest challenges.</p></li>
                ...
                <div id="contactdetails">
                    <h3 className="font-bold text-bg_variant1 ssm:text-lg">Let’s Connect!</h3>
