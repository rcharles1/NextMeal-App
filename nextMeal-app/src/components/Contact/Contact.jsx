...
function Contacts() {
    ...
    return (
        <div className="p-8 px-5 ssm:px-10 h-fit ssm:text-sm ssm:text-start ssm:flex ssm:space-x-8 text-winterWhite/75">
            <div className="hidden ssm:block h-fit p-2 w-6/12 pt-12 sticky top-10">
                <h3 className="font-bold text-base capitalize text-winterWhite/90">On this page</h3>
                <ul className="flex flex-col space-y-2 mt-1.5 pl-1 text-xs lg:text-sm">
                    <li>Introduction</li>
            ...
            <div id="page-content" className="space-y-8">
                <h1 className="font-black text-winterWhite/90 text-3xl gradient-text tracking-wide lg:text-5xl">Get in Touch</h1>
                <div className="">
                    <h3 className="font-bold text-winterWhite/90 lg:text-lg">Let’s Help You!</h3>
                ...
                <div>
                    <h3 className="font-bold text-winterWhite/90 lg:text-lg">Why Reach Out?</h3>
                    <ul className="mt-2 lg:text-lg ml-8 mb-4 list-disc space-y-3">
                ...
                <div>
                    <h3 className="font-bold text-winterWhite/90 lg:text-lg">Let’s Connect!</h3>
                ...
                <div>
                    <h3 className="font-bold text-winterWhite/90 lg:text-lg">Ready to Get Started?</h3>
