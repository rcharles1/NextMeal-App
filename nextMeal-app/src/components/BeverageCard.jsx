    ...
    return (
        <>
            { beverage ? (<div className="grid grid-cols-2 gap-x-0 gap-y-2.5 mx-1.5 sm:grid-cols-3 sm:gap-8 lg:gap-5">
                <div className="flex flex-col space-y-4 h-64 w-[11rem] rounded-xl sm:rounded-2xl px-2.5 pb-3.5 pt-3 text-base bg-pure_white drop-shadow-sm text-default/75 caret-transparent text-center sm:h-72 sm:w-56">
                    ...
                    <div className="w-fit h-fit ml-16 border-b-2 flex flex-row space-x-1">
                        <span><NavLink to={`/beverageitem/${beverage._id}`} className="font-semibold text-sm sm:text-base active:text-bg_variant1">Explore</NavLink></span>
