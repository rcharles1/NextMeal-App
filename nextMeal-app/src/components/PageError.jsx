...
function PageError() {
    ...
    return (
        <div className="h-screen bg-bg_variant1/15 p-10 w-full  outline caret-transparent text-lg font-medium text-default/75 antialised text-center">
            <div className="size-56 justify-center mx-auto">
                <Lottie animationData={errorAnimation} loop={true} speed={0.5}/>
            </div>
            <h1 className="text-bg_variant1 font-bold text-2xl mt-6 md:mt-4">ERROR 404: Not Found</h1>
                <p>Page Not Found</p>
            <div className="flex space-x-1.5 mt-2 mx-auto w-fit items-center mt-6 nd:mt-4">
